...
## Purpose
Provides developers visibility into notification send operations through a collapsible debug panel that displays send history, request/response details, and error diagnostics for troubleshooting FCM integration issues.
